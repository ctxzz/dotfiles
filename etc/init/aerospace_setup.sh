...
echo ""
echo "次のステップ:"
echo "  1. AeroSpaceを起動: open -a AeroSpace"
echo "  2. システム環境設定でアクセシビリティ権限を付与"
echo "  3. 設定を確認: aerospace list-workspaces"
echo ""
echo "キーバインド一覧:"
echo "  - Alt+H/J/K/L: フォーカス移動"
echo "  - Alt+Shift+H/J/K/L: ウィンドウ移動"
echo "  - Alt+I/O/P: Inbox/Office/Private ワークスペース"
echo "  - Alt+A/W/C/D/N/T/Z: 各種専用ワークスペース"
echo ""
echo "詳細は $HOME/.config/aerospace/aerospace.toml を参照してください"
